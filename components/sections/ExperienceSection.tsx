...
export default function ExperienceSection() {
  return (
    <section className="bg-black text-white  md:px-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 md:gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="flex gap-3 justify-center md:justify-start divide-x divide-gray-500 text-left">
  <div className="px-3">
        ...
        <div className="relative w-full md:w-1/2 flex justify-center">
          ...
          <div className=" z-10 md:w-[85%] md:h-[80%] rounded-3xl overflow-hidden shadow-lg flex flex-col items-centercenter">
            ...
            />
              ...
              <div className="absolute  bottom-20  md:bottom-20 md:left-10 -translate-x-1/2  bg-white/60 border-b border-white/60 text-black px-4 py-2 rounded-xl shadow-md z-20 text-3.5 text-center">
